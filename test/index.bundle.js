...
var out = function out() {
    ...
    return (_document$querySelect = document.querySelector('#result')).appendChild.apply(_document$querySelect, arguments);
};
var print = function print(raw, ref) {
    return function () {
        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        raw.apply(undefined, args);
...
console.warn = print(console.warn, function (p) {
    return p.style.backgroundColor = '#EE0000';
});
...
var fetch = window.fetch || function (url) {
    return new _promise2.default(function (resolve, reject) {
        ...
        request.addEventListener("load", function (_ref) {
            ...
            return resolve({ text: function text() {
                    return srcElement.responseText;
                } });
        }, false);
...
fetch('./src/match_test.js').then(function (r) {
    return r.text();
}).then(function (text) {
...
var anObject = __webpack_require__(3);
var toLength = __webpack_require__(15);
var getIterFn = __webpack_require__(26);
var BREAK = {};
var RETURN = {};
...
var _isInteger = __webpack_require__(77);
