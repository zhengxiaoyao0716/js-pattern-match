 ...
 * Base match.
 */
console.log((0, _index2.default)([num, str], [401, 'please sign in.']));
console.log((0, _index2.default)(function () {
...
var getLength = (0, _index2.default)([[[num, num, num], function (x, y, z) {
...
for (var _i = 0; _i < _arr.length; _i++) {
    var args = _arr[_i];
    try {
        console.log(args, ':', getLength.apply(undefined, (0, _toConsumableArray3.default)(args)));
    } catch (error) {
        console.warn('[WARN]', error);
    }
}
...
var nestedLog = (0, _index2.default)([[function (node) {
    return node.name == 'If' && (0, _index2.default)(function (alternate) {
        return alternate.name;
    }, [node.alternate]);
}, console.log.bind(console, 'matched alternate:')], [function (node) {
    return node.name == 'If' && (0, _index2.default)(function (consequent) {
 ...
 * test `this` refer.
 */
var testThis = (0, _index2.default)([[[function (n) {
    console.log('pattern.n:', this);return num(n);
}], function () {
    console.log('matched:', this);
}], [function () {
    console.log('pattern.args:', this);return arguments.length > 1;
}, function () {}]], function () {
...
/***/ })
/******/ ])));
//# sourceMappingURL=match_test.js.map